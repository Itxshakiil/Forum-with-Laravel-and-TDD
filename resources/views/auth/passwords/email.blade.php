...
<div class="container mx-auto flex justify-center px-6 my-12">
    <div class="w-full xl:w-3/4 lg:w-11/12 flex">
        ...
        <div class="w-full lg:w-1/2 bg-white p-5 rounded-lg lg:rounded-l-none">
            ...
            <form class="px-8 pt-6 mb-4 bg-white rounded" method="POST" action="{{ route('password.email') }}"
                  >
                  @if (session('status'))
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="email" type="email" placeholder="email@example.com" name="email" value="{{ old('email') }}" required
                        autocomplete="email" />
                    @error('email')
